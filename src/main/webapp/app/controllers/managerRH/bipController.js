        ...
        function ($scope,$cookies, $filter ,security, HTTP_METHOD, properties , utils,dao ) {
            ...
            var idCollaborateur = collaborateur.idUtilisateur;
                ...
                var listerObjectif= function () {
                    var task = dao.getData(properties.urlCollaborateur+"/"+idCollaborateur+"/objectifs", $scope.headerBasic, HTTP_METHOD.get);
                ...
                var task = dao.getData(properties.urlRespMesure, $scope.headerBasic, HTTP_METHOD.get);
                //on attent la reponse...
                task.promise.then(function (result) {
                    // fin d'attente
                    // erreur ?
                ...
                $scope.ajouterObjectif=function(){
                    ...
                    var task = dao.getData(properties.urlObjectif, $scope.headerBasic, HTTP_METHOD.post,objectif);
                    //on attent la reponse...
                    task.promise.then(function (result) {
                        // fin d'attente
                        // erreur ?
                ...
                $scope.ajouterMesure=function () {
                  var mesure= [{
                    ...
                    var task = dao.getData(properties.urlMesure, $scope.headerBasic, HTTP_METHOD.post,mesure);
                    //on attent la reponse...
                    task.promise.then(function (result) {
                        // fin d'attente
                        // erreur ?
                ...
                $scope.supprimerMesure=function(id){
                    ...
                    var task = dao.getData(properties.urlMesure+"/"+id, $scope.headerBasic, HTTP_METHOD.delete);
                    //on attent la reponse...
                    task.promise.then(function (result) {
                        // fin d'attente
                        // erreur ?
