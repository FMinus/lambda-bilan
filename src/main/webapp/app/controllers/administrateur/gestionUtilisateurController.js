        ...
        ['$scope','$cookies','$http','ngTableParams', '$filter','security', 'HTTP_METHOD','properties', 'utils','dao',
            ...
            // sinon on redirige vers la page login ou vers la page forbidden
                ...
                var lister=function() {
                    ...
                    var task = dao.getData(properties.urlUtilisateur, $scope.headerBasic, HTTP_METHOD.get);
                ...
                var supprimer=function(id){
                        var task=dao.getData(properties.urlUtilisateur+"/"+id,$scope.headerBasic,HTTP_METHOD.delete);
                        //on attent la reponse
                        task.promise.then(function(result){
                            // fin d'attente
                            // erreur ?
                ...
                var abandonner=function(id){
                        var task=dao.getData("/utilisateur/"+id,$scope.headerBasic,HTTP_METHOD.put);
                        //on attent la reponse
                        task.promise.then(function(result){
                            // fin d'attente
                            // erreur ?
                ...
                $scope.afficherBAPs=function(collaborateur){
                    console.log(angular.toJson(collaborateur));
